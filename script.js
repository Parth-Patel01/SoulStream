class SoulStreamUploader {
    ...
    initializeElements() {
        ...
        this.pauseUploadBtn = document.getElementById('pauseUploadBtn');
        this.resumeUploadBtn = document.getElementById('resumeUploadBtn');
    ...
    bindEvents() {
        ...
        this.resumeUploadBtn.addEventListener('click', () => this.resumeUpload());
    }
    ...
    pauseUpload() {
        ...
        // Update current upload item status
        if (this.currentUploadIndex < this.uploadQueue.length) {
            ...
            if (currentItem.status === 'uploading') {
                ...
                this.updateUploadProgress(currentItem, currentItem.progress);
            }
        }
    }
    ...
    resumeUpload() {
        this.isPaused = false;
        this.updateButtonStates();
        this.showToast('Upload resumed', 'success');
    ...
    async processUploadQueue() {
        while (this.currentUploadIndex < this.uploadQueue.length && !this.isPaused) {
            const uploadItem = this.uploadQueue[this.currentUploadIndex];
            
            if (uploadItem.status === 'pending' || uploadItem.status === 'paused') {
    ...
    updateButtonStates() {
        ...
        this.pauseUploadBtn.disabled = !isUploading || isPaused;
        this.resumeUploadBtn.disabled = !isUploading || !isPaused;
    }
